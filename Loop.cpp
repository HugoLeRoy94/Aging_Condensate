           ...
           bool rho_adjust)
{
  ...
  if (rho_adjust)
  {
    rho0 = rho + (0.1 - rho) * (diff(Rright, Rleft) / ell - dsl);
  }
  else
  {
    rho0 = rho;
...
Loop::Loop(const Loop &loop)
{
  ...
  Rright = loop.Rright;
  rho0 = loop.rho0;
  ell_coordinate_0 = loop.ell_coordinate_0;
...
{
  return ell_coordinate_0 < loop_right.ell_coordinate_0;
}
// ---------------------------------------------------------------------------
//-----------------------------------accessor---------------------------------
// ---------------------------------------------------------------------------
...
double Loop::get_ell_coordinate_0() const { return ell_coordinate_0; }
