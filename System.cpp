...
System::System(double ell_tot, double rho0, double temperature, int seed, bool adjust) : distrib(1, 10000000)
{
  ...
  dangling = Dangling(R0,linkers,linker_to_strand, 0., ell, rho, rho_adjust); // dummy dangling that helps generate crosslinkers but has none initially
  // ---------------------------------------------------------------------------
  ...
  dangling = Dangling(R0,linkers,linker_to_strand, 0., ell, rho, rho_adjust);
